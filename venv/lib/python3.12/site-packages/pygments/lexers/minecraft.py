...
class MCFunctionLexer(RegexLexer):
    ...
    # Used to denotate the start of a block comment, borrowed from Github's
    # mcfunction
    ...
    tokens = {
        ...
        "names": [
            ...
            # may add new commands, so we have a 'close-enough' regex which
            # catches them.
        ...
        "property.key": [
            ...
            (r"#?[a-z_][a-z_\.\-]*\:[a-z0-9_\.\-/]+(?=\s*\=)",
             Name.Attribute, "property.delimiter"),
