    ...
    tokens = {
        ...
        'into_code': [
            (words(('#let', '#set', '#show'), suffix=r'\b'),
             Keyword.Declaration, 'inline_code'),
            (words(('#import', '#include'), suffix=r'\b'),
             Keyword.Namespace, 'inline_code'),
            (words(('#if', '#for', '#while', '#export'),
             suffix=r'\b'), Keyword.Reserved, 'inline_code'),
            (r'#\{', Punctuation, 'code'),
            (r'#\(', Punctuation, 'code'),
            (r'(#[a-zA-Z_][a-zA-Z0-9_-]*)(\[)',
             bygroups(Name.Function, Punctuation), 'markup'),
            (r'(#[a-zA-Z_][a-zA-Z0-9_-]*)(\()',
             bygroups(Name.Function, Punctuation), 'code'),
        ...
        'markup': [
            ...
            (r'^(\s*)(-)(\s+)', bygroups(Whitespace,
             Punctuation, Whitespace)),  # unnumbered list
            (r'^(\s*)(\+)(\s+)', bygroups(Whitespace,
             Punctuation, Whitespace)),  # numbered list
            ...
            (words(('---', '\\', '~', '--', '...'), suffix=r'\B'),
             Punctuation),  # special chars shorthand
        ...
        'code': [
            ...
            # (r'(import|include)( *)(")([^"])(")',
            # bygroups(Keyword.Reserved, Text, Punctuation, String.Double,
            # Punctuation)),
            (r'([a-zA-Z_][a-zA-Z0-9_-]*)', Name.Variable),
            (r'[ \t\n]+', Whitespace),
