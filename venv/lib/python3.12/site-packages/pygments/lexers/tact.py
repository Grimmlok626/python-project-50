...
class TactLexer(RegexLexer):
    ...
    tokens = {
        ...
        'import-in': [
            (r'((?<=\.\.\.)|(?<![.$]))\b(import)\b(\s*)',
             bygroups(Punctuation, Keyword, Whitespace), 'import'),
        ],
        'import': [
            (r';', Punctuation, '#pop'),
            include('comments'),
        ...
        'struct-in': [
            (r'((?<=\.\.\.)|(?<![.$]))\b(struct|message)\b',
             bygroups(Punctuation, Keyword), 'struct'),
        ],
        'struct': [
            include('comments'),
        ...
        'const-declaration-in': [
            (r'(?=\b(?:(?:get|native|extends|mutates|virtual|override|inline|abstract)\s*)*const\b)',
             Keyword, 'const-declaration'),
        ],
        'const-declaration': [
            (r'(;)', Punctuation, '#pop'),
            (r'const', Keyword),
            (words(('get', 'native', 'extends', 'mutates', 'virtual',
             'override', 'inline', 'abstract'), suffix=r'\b'), Keyword),
        ...
        'annotation-in': [
            (r'(@)(\w+)(\()', bygroups(Keyword.Pseudo,
             Keyword, Punctuation), 'annotation')
        ],
        'annotation': [
            (r'\)', Punctuation, '#pop'),
        ...
        'struct-init-in': [
            (r'(\b\w+)(\s*)(\{)', bygroups(Name.Class,
             Whitespace, Punctuation), 'struct-init')
        ],
        'struct-init': [
            (r'(\})', Punctuation, '#pop'),
            include('comments'),
        ...
        'struct-property-in': [
            (r'(\b[\w]+)(\s*)(:)', bygroups(Name.Property,
             Whitespace, Punctuation), 'struct-property')
        ],
        'struct-property': [
            (r'(?=\}|\,)', Punctuation, '#pop'),
            include('comments'),
