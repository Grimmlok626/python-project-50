...
class UL4Lexer(RegexLexer):
    ...
    tokens = {
        ...
        # Ignore mode ignores everything upto the matching ``<?end ignore?>``
        # tag
        "ignore": [
            # Nested ``<?ignore?>`` tag
        ...
        "ul4": [
            ...
            # Date or datetime:
            # ``@(2000-02-29)``/``@(2000-02-29T12:34:56.987654)``
            (
            ...
            (
                ...
                Operator),
            # Keywords
            (words(("for", "in", "if", "else", "not",
             "is", "and", "or"), suffix=r"\b"), Keyword),
            # Builtin constants
        ...
        "end": [
            (r"\?>", Comment.Preproc, "#pop"),
            (words(("for", "if", "def", "while", "renderblock",
             "renderblocks"), suffix=r"\b"), Keyword),
            (r"\s+", Text),
        ],
