...
class DesktopLexer(RegexLexer):
    ...
    def analyse_text(text):
        if text.startswith("[Desktop Entry]"):
            return 1.0
        if re.search(r"^\[Desktop Entry\][ \t]*$", text[:500],
...
class PropertiesLexer(RegexLexer):
    ...
    tokens = {
        ...
        'escapes': [
            # line continuations; these gobble whitespace at the beginning of
            # the next line
...
class TerraformLexer(ExtendedRegexLexer):
    ...
    tokens = {
        ...
        'basic': [
            ...
            # List of attributes, e.g. ignore_changes = [last_modified,
            # filename]
            (r'(\[)([a-z_,\s]+)(\])',
...
class NestedTextLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'^([ ]*)(>)( )(.*?)([ \t]*)$', bygroups(Whitespace,
             Punctuation, Whitespace, Text, Whitespace)),
            ...
            # multiline key item: : ...
            (r'^([ ]*)(:)( )([^\n]*?)([ \t]*)$', bygroups(Whitespace,
             Punctuation, Whitespace, Name.Tag, Whitespace)),
...
class SingularityLexer(RegexLexer):
    ...
    def analyse_text(text):
        ...
        result = 0
        if re.search(r'\b(?:osversion|includecmd|mirrorurl)\b',
                     text, re.IGNORECASE):
            result += 0.5
