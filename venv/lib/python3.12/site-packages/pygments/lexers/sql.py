...
class PostgresExplainLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'(actual)( )(=?)', bygroups(Name.Class,
             Whitespace, Punctuation), 'instrumentation'),
            ...
            # We move to sort state in order to emphasize specific keywords
            ...
            (r'(Cache Key|Cache Mode)(:)( )', bygroups(
                Comment, Punctuation, Whitespace), 'object_name'),
        ...
        'setting': [
            (r'([a-z_]*?)(\s*)(=)(\s*)(\'.*?\')', bygroups(Name.Attribute,
             Whitespace, Operator, Whitespace, String)),
            (r'\, ', Punctuation),
        ],
        'init_plan': [
            (r'\(', Punctuation),
...
class GoogleSqlLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (words(_googlesql_builtins.constants,
