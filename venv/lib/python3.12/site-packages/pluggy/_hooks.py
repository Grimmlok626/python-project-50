...
def varnames(func: object) -> tuple[tuple[str, ...], tuple[str, ...]]:
    ...
    try:
        ...
        sig = inspect.signature(
            func.__func__ if inspect.ismethod(
                func) else func  # type:ignore[arg-type]
        )
...
_CallHistory = list[tuple[Mapping[str, object],
...
class HookCaller:
    ...
    def _verify_all_args_are_provided(
            self, kwargs: Mapping[str, object]) -> None:
    ...
    def __call__(self, **kwargs: object) -> Any:
        ...
        firstresult = self.spec.opts.get(
            "firstresult", False) if self.spec else False
...
class HookSpec:
    ...
    def __init__(self, namespace: _Namespace, name: str,
