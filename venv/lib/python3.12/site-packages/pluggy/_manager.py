...
_AfterTrace = Callable[[Result[Any], str,
                        Sequence[HookImpl], Mapping[str, Any]], None]


def _warn_for_function(
        warning: Warning, function: Callable[..., object]) -> None:
...
class PluginManager:
    ...
    def parse_hookimpl_opts(self, plugin: _Plugin,
                            name: str) -> HookimplOpts | None:
    ...
    def load_setuptools_entrypoints(
            self, group: str, name: str | None = None) -> int:
    ...
    def subset_hook_caller(
        ...
        plugins_to_remove = {
            plug for plug in remove_plugins if hasattr(
                plug, name)}
