...
class TagTracer:
    ...
    def _format_message(
            self, tags: Sequence[str], args: Sequence[object]) -> str:
    ...
    def _processmessage(
            self, tags: tuple[str, ...], args: tuple[object, ...]) -> None:
    ...
    def setprocessor(self, tags: str |
                     tuple[str, ...], processor: _Processor) -> None:
