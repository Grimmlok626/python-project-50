...
def validate(
    ...
    *,
    ...
    # Same as .splitlines(keepends=True), but doesn't split on linefeeds i.e.
    # \x0c
    ...
    for index, token in enumerate(expected_tokens_unprocessed[1:], start=1):
        ...
        current_token = token
        # Merge consecutive FSTRING_MIDDLE tokens. it's weird cpython has it
        # like that.
    ...
    for builtin_token, our_token in zip(
            expected_tokens, our_tokens, strict=True):
