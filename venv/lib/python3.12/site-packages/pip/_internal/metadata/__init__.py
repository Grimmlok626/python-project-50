...
def _should_use_importlib_metadata() -> bool:
    ...
    * On Python 3.11, 3.12 and 3.13, Python distributors can patch
    ...
    with contextlib.suppress(KeyError, ValueError):
        # On Python <3.14, if the environment variable is set, we obey what it
        # says.
    ...
    return bool(getattr(importlib.metadata,
...
def get_wheel_distribution(
        wheel: Wheel, canonical_name: str) -> BaseDistribution:
