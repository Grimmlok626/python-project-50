...
class Downloader:
    ...
    def __call__(self, link: Link, location: str) -> tuple[str, str]:
        ...
        filepath = os.path.join(
            location, _get_http_response_filename(
                resp, link))
    ...
    def _process_response(self, download: _FileDownload,
                          resp: Response) -> None:
        ...
        try:
            ...
            # If the download size is not known, then give up downloading the
            # file.
    ...
    def _attempt_resumes_or_redownloads(
        ...
        while download.reattempts < self._resume_retries and download.is_incomplete():
            ...
            try:
                ...
                # other unexpected status, restart the download from the
                # beginning.
        ...
        # No more resume attempts. Raise an error if the download is still
        # incomplete.
        if download.is_incomplete():
    ...
    def _cache_resumed_download(
        ...
        # Check if the adapter is the CacheControlAdapter (i.e. caching is
        # enabled)
    ...
    def _http_get(self, link: Link,
                  headers: Mapping[str, str] = HEADERS) -> Response:
