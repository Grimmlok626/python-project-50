...
class PipProvider(_ProviderBase):
    ...
    def identify(self, requirement_or_candidate: Requirement |
                 Candidate) -> str:
    ...
    def get_preference(
        ...
        * Alphabetical order for consistency (aids debuggability).
        ...
        if not has_information:
            ...
            # InstallRequirement (the second element) from
            # get_candidate_lookup()
            directs, ireqs = zip(
                *(
                    (isinstance(r, ExplicitRequirement),
                     r.get_candidate_lookup()[1])
        ...
        pinned = any(((op[:2] == "==") and ("*" not in ver))
