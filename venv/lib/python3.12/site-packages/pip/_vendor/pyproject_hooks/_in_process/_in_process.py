...
def _build_backend():
    ...
    if backend_path:
        # Ensure in-tree backend directories have the highest priority when
        # importing.
...
class _BackendPathFinder:
    ...
    def find_spec(self, fullname, _path, _target=None):
        ...
        if spec is None and fullname == self.backend_parent:
            ...
            # Therefore, we can halt the import machinery and raise a clean
            # error.
            msg = f"Cannot find module {
                self.backend_module!r} in {
                self.backend_path!r}"
