...
def _normalize_group_names(
    ...
    if errors:
        raise ValueError(
            f"Duplicate dependency group names: {
                ', '.join(errors)}")
...
class CyclicDependencyError(ValueError):
    ...
    def __init__(self, requested_group: str, group: str,
                 include_group: str) -> None:
...
class DependencyGroupResolver:
    ...
    def lookup(
            self, group: str) -> tuple[Requirement | DependencyGroupInclude, ...]:
        """
    ...
    def _resolve(self, group: str,
                 requested_group: str) -> tuple[Requirement, ...]:
        """
        ...
        for item in parsed:
            if isinstance(item, Requirement):
                ...
                if include_group in self._include_graph_ancestors.get(
                        group, ()):
