...
class LegacyWindowsTerm:
    ...
    # Indices are ANSI color numbers, values are the corresponding Windows
    # Console API color numbers
    ANSI_TO_WINDOWS = [
        0,
        # black                      The Windows colours are defined in wincon.h
        # as follows:
        ...
        8,
        # bright black (grey)         define BACKGROUND_INTENSITY       0x0080 --
        # 1000 0000
        12,  # bright red
        10,  # bright green
        14,  # bright yellow
...
if __name__ == "__main__":
    ...
    term.write_styled(
        ...
        style=Style.parse("black on cyan"))
    time.sleep(1)
    term.erase_line()
