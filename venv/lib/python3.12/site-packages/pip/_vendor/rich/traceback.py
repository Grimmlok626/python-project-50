        ...
        *,
        ...
        while True:
            ...
            for frame_summary, line_no in walk_tb(traceback):
                ...
                last_instruction: Optional[Tuple[Tuple[int,
                                                       int], Tuple[int, int]]]
        ...
        def render_stack(stack: Stack, last: bool) -> RenderResult:
            ...
            if stack.is_group:
                for group_no, group_exception in enumerate(stack.exceptions, 1):
                    ...
                    for group_last, group_stack in loop_last(
                            group_exception.stacks):
                        grouped_exceptions.append(
                            render_stack(group_stack, group_last))
                    yield ""
                    yield Constrain(
                        Panel(
                    ...
                    if frame.last_instruction is not None:
                        ...
                        for line1, column1, column2 in _iter_syntax_lines(
                            ...
                            try:
                                ...
                                # If last_instruction reports a line
                                # out-of-bounds, we don't want to crash
                                continue
