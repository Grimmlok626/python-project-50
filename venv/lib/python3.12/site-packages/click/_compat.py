...
def get_text_stdin(encoding: str | None = None,
...
def get_text_stdout(encoding: str | None = None,
                    errors: str | None = None) -> t.TextIO:
...
def get_text_stderr(encoding: str | None = None,
                    errors: str | None = None) -> t.TextIO:
...
if sys.platform.startswith("win") and WIN:
    ...
    _ansi_stream_wrappers: cabc.MutableMapping[t.TextIO,
                                               t.TextIO] = WeakKeyDictionary()

    def auto_wrap_for_ansi(stream: t.TextIO, color: bool |
                           None = None) -> t.TextIO:
