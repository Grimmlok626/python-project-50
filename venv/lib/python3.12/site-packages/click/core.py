...
class Context:
    ...
    def __init__(
        ...
        self._opt_prefixes: set[str] = set(
        ...
        self.token_normalize_func: t.Callable[[
            str], str] | None = token_normalize_func
    ...
    def __exit__(
        ...
        if self._depth == 0:
            exit_result = self._close_with_exception_info(
    ...
    @t.overload
    def invoke(self, callback: Command, /, *args: t.Any,
               **kwargs: t.Any) -> t.Any: ...
...
class Command:
    ...
    def __init__(
        ...
        self.context_settings: cabc.MutableMapping[str,
                                                   t.Any] = context_settings
    ...
    def get_params(self, ctx: Context) -> list[Parameter]:
        ...
        if __debug__:
            ...
            duplicate_opts = (opt for opt,
                              count in opts_counter.items() if count > 1)
    ...
    def invoke(self, ctx: Context) -> t.Any:
        ...
        if self.deprecated:
            extra_message = (
                f" {self.deprecated}" if isinstance(
                    self.deprecated, str) else ""
            )
            message = _(
...
class Group(Command):
    ...
    def result_callback(self, replace: bool = False) -> t.Callable[[F], F]:
        ...
        def decorator(f: F) -> F:
            ...
            def function(value: t.Any, /, *args: t.Any,
                         **kwargs: t.Any) -> t.Any:
...
class Parameter:
    ...
    def resolve_envvar_value(self, ctx: Context) -> str | None:
        ...
        if isinstance(self.envvar, str):
            ...
            for envvar in self.envvar:
                ...
                # Return the first non-empty value of the list of environment
                # variables.
                if rv:
                    return rv
    ...
    def value_from_envvar(
            self, ctx: Context) -> str | cabc.Sequence[str] | None:
    ...
    def handle_parse_result(
        ...
        if (
            ...
            # not to be exposed. We still assert it here to please the type
            # checker.
...
class Option(Parameter):
    ...
    def __init__(
        ...
        **attrs: t.Any,
        ...
        if is_flag:
            # Set missing default for flags if not explicitly required or
            # prompted.
    ...
    def prompt_for_value(self, ctx: Context) -> t.Any:
        ...
        if self.is_bool_flag:
            ...
            # Refs:
            # https://github.com/pallets/click/pull/3030#discussion_r2289180249
            else:
    ...
    def value_from_envvar(self, ctx: Context) -> t.Any:
        ...
        # Absent environment variable or an empty string is interpreted as
        # unset.
        if rv is None:
            return None
    ...
    def consume_value(
        ...
        if value is FLAG_NEEDS_VALUE:
            # If the option allows for a prompt, we start an interaction with
            # the user.
        ...
        # FLAG_NEEDS_VALUE sentinel) with the flag_value.
            ...
            value = [
                self.flag_value if v is FLAG_NEEDS_VALUE else v for v in value]
            source = ParameterSource.COMMANDLINE
    ...
    def type_cast_value(self, ctx: Context, value: t.Any) -> t.Any:
        if self.is_flag and not self.required:
            if value is UNSET:
                if self.is_bool_flag:
                    # If the flag is a boolean flag, we return False if it is
                    # not set.
                    value = False
...
class Argument(Parameter):
    ...
    def __init__(
        ...
        **attrs: t.Any,
        ...
        # Auto-detect the requirement status of the argument if not explicitly
        # set.
        if required is None:
