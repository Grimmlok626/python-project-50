...
class ParamType:
    ...
    def get_missing_message(self, param: Parameter,
                            ctx: Context | None) -> str | None:
...
class Choice(ParamType, t.Generic[ParamTypeValue]):
    ...
    def normalize_choice(self, choice: ParamTypeValue,
        ...
        .. versionadded:: 8.2.0
        """
        normed_value = choice.name if isinstance(
            choice, enum.Enum) else str(choice)
    ...
    def get_invalid_choice_message(
            self, value: t.Any, ctx: Context | None) -> str:
        ...
        """
        choices_str = ", ".join(
            map(repr, self._normalized_mapping(ctx=ctx).values()))
        return ngettext(
...
class Tuple(CompositeParamType):
    ...
    def __init__(self, types: cabc.Sequence[type[t.Any] | ParamType]) -> None:
        self.types: cabc.Sequence[ParamType] = [
