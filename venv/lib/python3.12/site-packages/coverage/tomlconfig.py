...
class TomlConfigParser:
    ...
    def _get_section(
            self, section: str) -> tuple[str | None, TConfigSectionOut | None]:
    ...
    def _check_type(
        ...
        if isinstance(value, str) and converter is not None:
            try:
                ...
                raise ValueError(
                    f"Option [{section}]{option} couldn't convert to {type_desc}: {
                        value!r}",
                ) from e
        raise ValueError(
    ...
    def getboolean(self, section: str, option: str) -> bool:
        ...
        return self._check_type(name, option, value, bool,
                                bool_strings.__getitem__, "a boolean")
