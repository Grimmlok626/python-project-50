...
class CoverageConfig(TConfigurable, TPluginConfig):
    ...
    def __init__(self) -> None:
        ...
        # We did read these config files, but maybe didn't find any content for
        # us.
    ...
    def from_file(self, filename: str, warn: Callable[[
                  str], None], our_file: bool) -> bool:
        ...
        try:
            ...
            raise ConfigError(
                f"Couldn't read config file {filename}: {err}") from err
        if not files_read:
            return False
    ...
    def set_option(self, option_name: str, value: TConfigValueIn |
        ...
        if key and plugin_name in self.plugins:
            self.plugin_options.setdefault(
                plugin_name, {})[key] = value  # type: ignore[index]
            return
    ...
    def post_process(self) -> None:
        ...
        self.paths = {k: [process_file_value(f) for f in v]
...
def config_files_to_try(
        config_file: bool | str) -> list[tuple[str, bool, bool]]:
