...
def combinable_files(data_file: str,
                     data_paths: Iterable[str] | None = None) -> list[str]:
    ...
    files_to_combine = [
        fnm for fnm in files_to_combine if not fnm.endswith("-journal")]
    ...
    for f in files_to_combine:
        ...
        if combine_this_one:
            ...
            try:
                ...
                if message:
                    message(
                        f"Couldn't combine data file {rel_file_name}: {exc}")
