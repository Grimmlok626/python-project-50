...
class Collector:
    ...
    def __init__(
        ...
        assert isinstance(
            self.concurrency, list), f"Expected a list: {
            self.concurrency!r}"
        ...
        if self.concur_id_func and not hasattr(
                core.tracer_class, "concur_id_func"):
            raise ConfigError(
    ...
    #
    # New in 3.12: threading.settrace_all_threads:
    # https://github.com/python/cpython/pull/96681

    def _installation_trace(self, frame: FrameType,
                            event: str, arg: Any) -> TTraceFn | None:
    ...
    def disable_plugin(self, disposition: TFileDisposition) -> None:
        ...
        self.warn(
            f"Disabling plug-in {plugin_name!r} due to previous exception")
