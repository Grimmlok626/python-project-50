...
class Analysis:
    ...
    def executed_branch_arcs(self) -> dict[TLineNo, list[TLineNo]]:
        ...
        for l1, l2 in self.arcs_executed:
            assert l1 != l2, f"Oops: Didn't think this could happen: {
                l1 =}, {
                l2 =}"
...
class AnalysisNarrower:
    ...
    def __init__(self, analysis: Analysis) -> None:
        ...
        self.region2arc_possibilities: dict[TRegionLines,
                                            set[TArc]] = collections.defaultdict(set)
        self.region2arc_executed: dict[TRegionLines,
                                       set[TArc]] = collections.defaultdict(set)
    ...
    def add_regions(self, liness: Iterable[set[TLineNo]]) -> None:
        ...
        if self.analysis.has_arcs:
            ...
            collect_arcs(
                self.analysis.arc_possibilities_set,
                self.region2arc_possibilities)
            collect_arcs(
                self.analysis.arcs_executed_set,
