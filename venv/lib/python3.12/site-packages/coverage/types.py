...
TConfigValueIn = Optional[Union[bool, int, float,
                                str, Iterable[str], Mapping[str, Iterable[str]]]]
TConfigValueOut = Optional[Union[bool, int,
                                 float, str, list[str], dict[str, list[str]]]]
